		...
		SpaceCDN: function () {
			...
			switch( true )
			  { 
     			    case traf < 2000: 
			    result = result = Math.ceil(traf * 0.05);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 
			 
		            case traf >= 2000 && traf < 10000:
			    result = result = Math.ceil(traf * 0.045);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 

		            case traf >= 10000 && traf < 20000:
			    result = result = Math.ceil(traf * 0.037);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 
			    ...
			    result = result = Math.ceil(traf * 0.025);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 
		            ...
		            case traf >= 100000 && traf < 200000:
			    result = result = Math.ceil(traf * 0.021);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 

		            case traf >= 200000 && traf < 400000:
			    result = result = Math.ceil(traf * 0.018);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 

		            case traf >= 400000 && traf < 1000000:
			    result = result = Math.ceil(traf * 0.0165);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 

		            case traf >= 1000000:
			    result = result = Math.ceil(traf * 0.015);
 			    show_cdn_plan_notes("SpaceCDN","HighWinds Global");
 	  		    break; 
  	 		  }
